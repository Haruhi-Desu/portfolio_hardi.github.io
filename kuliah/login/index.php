...
<body>
  <form class="form-signin" method="POST" action="cek_login.php">
    <div class="text-center mb-4">
      <img class="mb-4" src="../img/UI2.png" alt="" width="72" height="72">
   ...
   <center><a class="btn btn-danger btn-lg" href=".../registrasi/registrasi.php" role="button">Registrasi</a></center>
    <p class="mt-5 mb-3 text-muted text-center">&copy; create by M.Hardiansyah 2020-<?= date('Y') ?></p>
  </form>
</body>
