<?php 
 ...
 <body>
 	...
 	<form action="" method="POST" enctype="multipart/form-data">
 		...
 		<input type="text" name="nim" placeholder="NIM"><br><p>
 		<input type="text" name="nama_mhs" placeholder="Nama Mahasiswa"><br><p>
 		<input type="date" name="tgl_lahir" ><p>
 		<textarea name="alamat" placeholder="Alamat"></textarea><br><p>
 		<input type="text" name="no_tp" placeholder="Nomor Telepon"><br><p>
