...
<!-- AKHIR NAVBAR -->
    ...
    <center><a href="formulir.php">+ &nbsp; Tambah Siswa</a><center>
    	</div>
...
<tbody>
	...
	<tr>
		...
		<td> <a href="edit.php?id=<?=$row["nim"] ?>">edit</a> || 
			 <a href="hapus.php?id=<?=$row["nim"] ?>" onclick="return confirm('Yakin ingin menghapus data ?');">hapus</a>
			</td>
			</tr>
	<?php endforeach ; ?>
